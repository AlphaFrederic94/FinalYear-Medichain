...
module.exports = {
  // Encounters
  createEncounter:      wrap((req) => svc.createEncounter(req.user.did, req.body)),
  getEncounter:         wrap((req) => svc.getEncounter(req.params.id)),
  getPatientRecords:    wrap((req) => svc.getPatientRecords(req.params.did)),

  // Diagnoses
  addDiagnosis:         wrap((req) => svc.addDiagnosis(req.user.did, req.body)),
  getPatientDiagnoses:  wrap((req) => svc.getPatientDiagnoses(req.params.did)),

  // Prescriptions
  createPrescription:   wrap((req) => svc.createPrescription(req.user.did, req.body)),
  ...
  // Vitals
  recordVitals:         wrap((req) => svc.recordVitals(req.user.did, req.body)),
  ...
  // Documents
  uploadDocument:       wrap((req) => svc.uploadDocument(req.user.did, req.body)),
