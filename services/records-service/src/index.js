...
const swaggerSpec = swaggerJsdoc({
  definition: {
    openapi: '3.0.0',
    info: { title: 'AfriHealth Chain — Records Service', version: '1.0.0' },
...
app.get('/records/api-docs-json', (req, res) => res.json(swaggerSpec));
...
const start = async () => {
  try {
    ...
    app.listen(env.PORT, () => {
      logger.info(`Records service running on port ${env.PORT}`);
