...
const swaggerSpec = swaggerJsdoc({
  definition: {
    openapi: '3.0.0',
    info: { title: 'AfriHealth Chain — Patient Service', version: '1.0.0' },
...
app.get('/patients/api-docs-json', (req, res) => res.json(swaggerSpec));
...
const start = async () => {
  try {
    ...
    app.listen(env.PORT, () => {
      logger.info(`Patient service running on port ${env.PORT}`);
