...
const listAllPatients = wrap(() => svc.listAllPatients());
const assignDoctor = wrap((req) => svc.assignDoctor(req.params.did, req.body.assignedDoctorDid, req.body.assignedDoctorName));
